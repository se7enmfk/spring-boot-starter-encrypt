 ...
 * columnBaseConstant  【实体】是否生成字段常量（默认 false）
...
public class ConfigGenerator {
	...
	public boolean namingOfHump = false;

    protected String saveDirXml;

	protected String saveDirJava;
	 ...
	 */
	protected boolean columnBaseConstant = false;
	...
	protected IdType idType = IdType.INPUT;
    ...
    public ConfigGenerator setAuthor(String author) {
        this.author = author;
        return this;
    }
	...
	public boolean isColumnBaseConstant() {
		return columnBaseConstant;
	}

	public void setColumnBaseConstant(boolean columnBaseConstant) {
		this.columnBaseConstant = columnBaseConstant;
	}
	...
	public boolean isNamingOfHump() {
		return namingOfHump;
	}

	public void setNamingOfHump(boolean namingOfHump) {
		this.namingOfHump = namingOfHump;
	}
    ...
    public String getSaveDirXml() {
        return saveDirXml;
    }

    public void setSaveDirXml(String saveDirXml) {
        this.saveDirXml = saveDirXml;
    }

    public String getSaveDirJava() {
        return saveDirJava;
    }

    public void setSaveDirJava(String saveDirJava) {
        this.saveDirJava = saveDirJava;
    }
}
